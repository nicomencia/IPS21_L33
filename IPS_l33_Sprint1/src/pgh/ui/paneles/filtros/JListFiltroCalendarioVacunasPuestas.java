...
import pgh.ui.paneles.filtros.JListFiltroCalendarioVacunas.Filtro;
import pgh.ui.paneles.filtros.JListFiltroCalendarioVacunas.TextoFiltro;

public class JListFiltroCalendarioVacunasPuestas extends JList {
	
	
	private TextoFiltro texto;
	

	public JListFiltroCalendarioVacunasPuestas(DefaultListModel<Vacuna> model) {
