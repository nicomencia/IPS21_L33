...
public class JListFiltroEnfermeroSustitutosAsignarCitas extends JList {

	private TextoFiltro texto;
	

	public JListFiltroEnfermeroSustitutosAsignarCitas(DefaultListModel<EnfermeroSustituto> model) {
