...
public class CrearVacacionesSolicitadasMedico {
	
private static String SQL = "Insert into Vacaciones_Medico_solicitadas (idVacaciones_Solicitadas_Medico, idMedico, dia_Inicio, dia_Fin, motivo, nombreMedico, aprobadas, canceladas, esperando) values (?,?,?,?,?,?,?,?,?) ";

	
	Database db = new Database();
	
	public void crearVacaciones(VacacionesSolicitadasMedico vacaciones) {
