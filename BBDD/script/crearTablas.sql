...
--EMFERMEDAD
CREATE TABLE EMFERMEDAD (ID_EMFERMEDAD INT, NOMBRE VARCHAR(200), FECHA_INICIO DATE, ID_PACIENTE INT, CONSTRAINT PK_ID_EMFERMEDAD PRIMARY KEY (ID_EMFERMEDAD, ID_PACIENTE), CONSTRAINT FK_EMFERMEDAD_PACIENTE FOREIGN KEY (ID_PACIENTE) REFERENCES PACIENTE);
-- ENFERMERO_CITAS
