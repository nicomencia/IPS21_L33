...
-- MEDICAMENTO
CREATE TABLE MEDICAMENTO (IDMEDICAMENTO INT, IDPRESCRIPCION INT, CANTIDAD INT, INTERVALO VARCHAR(20), DURACION VARCHAR(20), ANOTACION VARCHAR(50), CONSTRAINT PK_MEDICAMENTO PRIMARY KEY (IDMEDICAMENTO), CONSTRAINT FK_MEDICAMENTO_PRESCRIPCION FOREIGN KEY (IDPRESCRIPCION) REFERENCES PRESCRIPCION)
-- DIAGNOSTICO 
