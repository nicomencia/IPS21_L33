...
--EMFERMEDAD
CREATE TABLE EMFERMEDAD (IDEMFERMEDAD INT, IDPACIENTE INT, ID_DIAGNOSTICO VARCHAR(5), EMFERMEDAD VARCHAR(20), FECHA_INICIO DATE, CONSTRAINT PK_ID_EMFERMEDAD PRIMARY KEY (IDEMFERMEDAD), CONSTRAINT FK_EMFERMEDAD_DIAGNOSTICO FOREIGN KEY (ID_DIAGNOSTICO) REFERENCES DIAGNOSTICO, CONSTRAINT FK_EMFERMEDAD_PACIENTE FOREIGN KEY (IDPACIENTE) REFERENCES PACIENTE);