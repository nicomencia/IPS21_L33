...
-- CITA
CREATE TABLE CITA (IDCITA INT, IDPACIENTE INT, IDHORARIO INT, IDUBICACION INT, FECHA DATE, ASISTENCIA BOOLEAN, URGENTE BOOLEAN, INFOCONTACTO VARCHAR(200), NOMBREPACIENTE VARCHAR(50), CONSTRAINT PK_CITA PRIMARY KEY (IDCITA), CONSTRAINT FK_CITA_PACIENTE FOREIGN KEY (IDPACIENTE) REFERENCES PACIENTE, CONSTRAINT FK_CITA_HORARIO FOREIGN KEY (IDHORARIO) REFERENCES HORARIO, CONSTRAINT FK_CITA_UBICACION FOREIGN KEY (IDUBICACION) REFERENCES UBICACION);
-- CAUSA
