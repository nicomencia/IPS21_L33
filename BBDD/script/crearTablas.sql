...
-- PRESCRIPCION
CREATE TABLE PRESCRIPCION (IDPRESCRIPCION INT, IDCITA INT, IDPACIENTE INT, INSTRUCCION VARCHAR(100), HORA_ASIGNACION VARCHAR(20), DIA_ASIGNACION DATE, ES_MEDICAMENTO BOOLEAN, CONSTRAINT PK_PRESCRIPION PRIMARY KEY (IDPRESCRIPCION), CONSTRAINT FK_PRESCRIPCION_CITA FOREIGN KEY (IDCITA) REFERENCES CITA, CONSTRAINT FK_PRESCRIPCION_PACIENTE FOREIGN KEY (IDPACIENTE) REFERENCES PACIENTE);
-- MEDICAMENTO
CREATE TABLE MEDICAMENTO (IDMEDICAMENTO INT, IDPRESCRIPCION INT, CANTIDAD INT, INTERVALO VARCHAR(20), DURACION VARCHAR(20), ANOTACION VARCHAR(100), CONSTRAINT PK_MEDICAMENTO PRIMARY KEY (IDMEDICAMENTO), CONSTRAINT FK_MEDICAMENTO_PRESCRIPCION FOREIGN KEY (IDPRESCRIPCION) REFERENCES PRESCRIPCION)
-- DIAGNOSTICO 
