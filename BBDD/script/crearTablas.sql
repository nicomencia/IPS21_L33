...
-- CITAPROPUESTA
CREATE TABLE CITAPROPUESTA (IDCITAPROPUESTA INT, IDPACIENTE INT, IDHORARIO INT, IDUBICACION INT, FECHA DATE, URGENTE BOOLEAN, INFOCONTACTO VARCHAR(200), NOMBREPACIENTE VARCHAR(50), MEDICOASIGNADO BOOLEAN, PENDIENTEAPROBACION BOOLEAN, CONSTRAINT PK_CITAPROPUESTA PRIMARY KEY (IDCITAPROPUESTA), CONSTRAINT FK_CITAPROPUESTA_PACIENTE FOREIGN KEY (IDPACIENTE) REFERENCES PACIENTE, CONSTRAINT FK_CITAPROPUESTA_HORARIO FOREIGN KEY (IDHORARIO) REFERENCES HORARIO, CONSTRAINT FK_CITAPROPUESTA_UBICACION FOREIGN KEY (IDUBICACION) REFERENCES UBICACION);
...
--EMFERMEDAD
CREATE TABLE EMFERMEDAD (ID_EMFERMEDAD INT, NOMBRE VARCHAR(20), FECHA_INICIO DATE, ID_PACIENTE INT, CONSTRAINT PK_ID_EMFERMEDAD PRIMARY KEY (ID_EMFERMEDAD, ID_PACIENTE), CONSTRAINT FK_EMFERMEDAD_PACIENTE FOREIGN KEY (ID_PACIENTE) REFERENCES PACIENTE);
