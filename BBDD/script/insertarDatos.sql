...
--MEDICO (1000 - 1099)
INSERT INTO MEDICO (IDMEDICO, NOMBRE, APELLIDOS, EMAIL, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('1000', 'JOSE', 'GUTIERREZ PRADOS', 'jpjose@gmail.com', 'CIRUJANO', '7000','30');
INSERT INTO MEDICO (IDMEDICO, NOMBRE, APELLIDOS, EMAIL, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('1001', 'ANDRES', 'ORTIZ GARRIDO', 'aortiz@gmail.com', 'CIRUJANO', '7001','30');
INSERT INTO MEDICO (IDMEDICO, NOMBRE, APELLIDOS, EMAIL, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('1002', 'MARIA', 'ARDURA MENENDEZ', 'mariaam@gmail.com', 'PEDIATRA', '7001','30');
INSERT INTO MEDICO (IDMEDICO, NOMBRE, APELLIDOS, EMAIL, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('1003', 'CRISTINA', 'GABRIEL ENJUNTO', 'enjuntoc@gmail.com', 'GENERAL', '7000','30');
INSERT INTO MEDICO (IDMEDICO, NOMBRE, APELLIDOS, EMAIL, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('1004', 'CHRISTIAN', 'DOMINGUEZ ALVAREZ', 'chris@gmail.com', 'PSIQUIATRA', '7000','30');
...
--ENFERMEROSUSTITUTO (4900 - 4999)
INSERT INTO ENFERMEROSUSTITUTO (IDENFERMEROSUSTITUTO, NOMBRE, APELLIDOS, EMAIL) VALUES ('4900', 'MARTIN', 'MARTINEZ PRADOS', 'mpp@gmail.com');
INSERT INTO ENFERMEROSUSTITUTO (IDENFERMEROSUSTITUTO, NOMBRE, APELLIDOS, EMAIL) VALUES ('4901', 'ANDRES', 'LOPEZ LOPEZ', 'AndresLopez@gmail.com');
INSERT INTO ENFERMEROSUSTITUTO (IDENFERMEROSUSTITUTO, NOMBRE, APELLIDOS, EMAIL) VALUES ('4902', 'PAULA', 'ARDURA LOPEZ', 'pau@gmail.com');
INSERT INTO ENFERMEROSUSTITUTO (IDENFERMEROSUSTITUTO, NOMBRE, APELLIDOS, EMAIL) VALUES ('4903', 'ROSALIA', 'GARCIA GARCIA', 'laRosi@gmail.com');
INSERT INTO ENFERMEROSUSTITUTO (IDENFERMEROSUSTITUTO, NOMBRE, APELLIDOS, EMAIL) VALUES ('4904', 'CARLOS', 'ARIAS GARCIA', 'marley@gmail.com');

--VACACIONES SOLICITADAS MEDICO(4700 - 4799)
--VACACIONES SOLICITADAS ENFERMERO(5000 - 5999)
...
INSERT INTO JORNADA_MEDICO (IDJORNADA_MEDICO, IDMEDICO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('1200', '1000', 'lunes, martes, miercoles, jueves, viernes','2020-5-1', '2021-5-22', '10:00', '16:00');
INSERT INTO JORNADA_MEDICO (IDJORNADA_MEDICO, IDMEDICO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('1201', '1001', 'lunes, martes, miercoles, jueves, viernes','2020-1-01', '2021-1-1', '22:00', '6:00');
INSERT INTO JORNADA_MEDICO (IDJORNADA_MEDICO, IDMEDICO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('1202', '1002', 'lunes, martes, miercoles, jueves, viernes','2020-3-04', '2021-3-22', '14:00', '18:00');
INSERT INTO JORNADA_MEDICO (IDJORNADA_MEDICO, IDMEDICO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('1203', '1003', 'lunes, martes, miercoles, jueves, viernes','2020-1-1', '2021-1-22', '19:00', '23:00');
INSERT INTO JORNADA_MEDICO (IDJORNADA_MEDICO, IDMEDICO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('1204', '1004', 'lunes, martes, miercoles, jueves, viernes','2020-7-29', '2020-7-27', '8:00', '16:00');

--ENFERMERO (2000 - 2099)
INSERT INTO ENFERMERO (IDENFERMERO, NOMBRE, APELLIDOS, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('2000', 'JAVIER', 'GARCIA LOPEZ', 'ANESTESISTA', '7000','30');
INSERT INTO ENFERMERO (IDENFERMERO, NOMBRE, APELLIDOS, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('2001', 'PABLO', 'MENENDEZ GONZALEZ', 'QUIROFANO', '7001','30');
INSERT INTO ENFERMERO (IDENFERMERO, NOMBRE, APELLIDOS, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('2002', 'PAULA', 'MARTINEZ MARTINEZ', 'PEDIATRA', '7001','30');
INSERT INTO ENFERMERO (IDENFERMERO, NOMBRE, APELLIDOS, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('2003', 'DAVID', 'ARES ALVAREZ', 'GENERAL', '7000','30');
INSERT INTO ENFERMERO (IDENFERMERO, NOMBRE, APELLIDOS, ESPECIALIDAD, IDEQUIPO_MEDICO, DIASDISPONIBLES) VALUES ('2004', 'JORGE', 'RODRIGUEZ MUÑIZ', 'SALUD MENTAL', '7000','30');
...
INSERT INTO JORNADA_ENFERMERO (IDJORNADA_ENFERMERO, IDENFERMERO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('2200', '2000', 'lunes, martes, miercoles, jueves, viernes','2020-5-5', '2021-5-5', '9:00', '20:00');
INSERT INTO JORNADA_ENFERMERO (IDJORNADA_ENFERMERO, IDENFERMERO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('2201', '2001', 'lunes, martes, miercoles, jueves, viernes','2020-4-20', '2021-4-20', '7:30', '4:30');
INSERT INTO JORNADA_ENFERMERO (IDJORNADA_ENFERMERO, IDENFERMERO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('2202', '2002', 'lunes, martes, miercoles, jueves, viernes','2020-2-10', '2021-2-28', '9:00', '20:00');
INSERT INTO JORNADA_ENFERMERO (IDJORNADA_ENFERMERO, IDENFERMERO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('2203', '2003', 'lunes, martes, miercoles, jueves, viernes','2020-6-29', '2021-6-28', '11:00', '17:00');
INSERT INTO JORNADA_ENFERMERO (IDJORNADA_ENFERMERO, IDENFERMERO, DIAS, DIA_INICIO, DIA_FIN, HORA_INICIO, HORA_FIN) VALUES ('2204', '2004', 'lunes, martes, miercoles, jueves, viernes','2020-7-14', '2020-7-23', '12:00', '18:00');
...
--CITA (4000 - 4099)
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4000','3000','6000', '5000', '2020-11-11', 'true', 'false', 'roberdlf@gmail.com','ROBERTO ALVAREZ DE LA FUENTE', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4001','3001','6001', '5001', '2021-8-12', 'false', 'false', '715846920','LAURA GONZALEZ VALDES', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4002','3002','6002', '5002', '2021-2-15', 'false', 'false', '688552317','MARIO MARTINEZ ALONSO', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4003','3003','6003', '5003', '2021-4-23', 'false', 'true', 'juanmf@gmail.com','LUCAS SEIZ ORTEGA', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4004','3004','6004', '5004', '2021-5-17', 'false', 'true', 'Llamar al 658471524 entre las 12 y las 4','FRANCISCO MATAMOROS DIAZ', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4005','3004','6005', '5004', '2021-11-22', 'false', 'false', 'Llamar al 658471524 entre las 12 y las 4','FRANCISCO MATAMOROS DIAZ', 'true');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE, MEDICOASIGNADO) VALUES ('4006','3000','6005', '5004', '2021-1-22', 'false', 'false', 'Llamar al 658471524 entre las 12 y las 4','ROBERTO ALVAREZ DE LA FUENTE', 'true');
--CAUSA (4100 - 4199)
...
INSERT INTO MEDICO_CITAS (IDCITA, IDMEDICO) VALUES ('4005', '1004');
INSERT INTO MEDICO_CITAS (IDCITA, IDMEDICO) VALUES ('4006', '1000');
...
INSERT INTO ENFERMERO_CITAS (IDCITA, IDENFERMERO) VALUES ('4005', '2004');
INSERT INTO ENFERMERO_CITAS (IDCITA, IDENFERMERO) VALUES ('4006', '2000');

--REGISTRO
INSERT INTO REGISTRO (IDREGISTRO, FECHA, DESCRIPCION) VALUES ('99000', '2020-11-25 12:00:15', 'El medico JOSE GUTIERREZ PRADOS (1000) diagnostico al paciente MARIO MARTINEZ ALONSO (3002) con Dolor intenso el brazo derecho');
INSERT INTO REGISTRO (IDREGISTRO, FECHA, DESCRIPCION) VALUES ('99001', '2020-11-27 10:32:08', 'El enfermero PAULA MARTINEZ MARTINEZ (2002) vacuno al paciente LAURA GONZALEZ VALDES (3001) con Tetanos');
--GERENTE
INSERT INTO GERENTE (IDGERENTE, NOMBRE, EMAIL) VALUES ('1000', 'Alberto Martinez Martinez', 'gerentedehospital123@gmail.com');
