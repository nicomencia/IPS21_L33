...
--CITA (4000 - 4099)
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4000','3000','6000', '5000', '2020-11-11', 'false', 'false', 'roberdlf@gmail.com','ROBERTO ALVAREZ DE LA FUENTE');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4001','3001','6001', '5001', '2020-8-12', 'false', 'false', '715846920','LAURA GONZALEZ VALDES');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4002','3002','6002', '5002', '2020-2-15', 'true', 'false', '688552317','MARIO MARTINEZ ALONSO');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4003','3003','6003', '5003', '2020-4-23', 'false', 'true', 'juanmf@gmail.com','LUCAS SEIZ ORTEGA');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4004','3004','6004', '5004', '2020-5-17', 'true', 'true', 'Llamar al 658471524 entre las 12 y las 4','FRANCISCO MATAMOROS DIAZ');
INSERT INTO CITA (IDCITA, IDPACIENTE, IDHORARIO, IDUBICACION, FECHA, ASISTENCIA, URGENTE, INFOCONTACTO, NOMBREPACIENTE) VALUES ('4005','3004','6005', '5004', '2020-11-22', 'true', 'false', 'Llamar al 658471524 entre las 12 y las 4','FRANCISCO MATAMOROS DIAZ');
